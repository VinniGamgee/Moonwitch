...
Options:
    ...
    -b, --build-type <TYPE>	Build type (variable: TYPE)
                          	...
                          	Default: Debug
    -n, --nightly           Create a Moonwitch Nightly build.

Extra arguments are passed to CMake.
...
echo "-- Done! Moonwitch APK and AAB artifacts are in ${ARTIFACTS_DIR}"
ls -l "${ARTIFACTS_DIR}/"
