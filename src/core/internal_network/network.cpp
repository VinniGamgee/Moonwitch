...
#undef NETWORK_PROTOCOL_TRANSLATE_ELEM
    default:
        LOG_WARNING(Network, "Unimplemented native protocol={}, falling back to Protocol::IP", protocol);
        return Protocol::IP;
    }
}
...
#undef NETWORK_PROTOCOL_TRANSLATE_ELEM
    default:
        LOG_WARNING(Network, "Unimplemented protocol={}, falling back to IPPROTO_IP", static_cast<u32>(protocol));
        return 0;
    }
}
