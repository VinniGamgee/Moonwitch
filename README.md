...
* **Мгновенное отображение версий**: показ как отображаемой версии игры (например, `v1.3.0`), так и внутренней версии патча (например, `v196608`) прямо на карточках и обложках.
